# Implement New Service Feature - AI Execution Template
...
```
Title: [Feature Name]
Context: [What feature does, why needed]
Requirements:
- [Requirement 1: e.g., Create new service for X]
- [Requirement 2: e.g., Implement Y with validation Z]
- [Requirement 3: e.g., UI component with drag-and-drop]
```
