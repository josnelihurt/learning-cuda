...
TEST_F(CommandFactoryTest, SimpleTypeIsRegistered) {
    // Arrange
    auto program_type = infrastructure::config::models::ProgramType::Simple;
...
TEST_F(CommandFactoryTest, GrayscaleTypeIsRegistered) {
    // Arrange
    auto program_type = infrastructure::config::models::ProgramType::Grayscale;
...
TEST_F(CommandFactoryTest, CreateSimpleCommand) {
    ...
    infrastructure::config::models::ProgramConfig config{
        ...
        .program_type = infrastructure::config::models::ProgramType::Simple
    };
...
TEST_F(CommandFactoryTest, CreateGrayscaleCommand) {
    ...
    infrastructure::config::models::ProgramConfig config{
        ...
        .program_type = infrastructure::config::models::ProgramType::Grayscale
    };
...
TEST_F(CommandFactoryTest, CreateWithSimpleTypeReturnsValidCommand) {
    ...
    // Act
    auto command = uut.create(infrastructure::config::models::ProgramType::Simple, config);
...
TEST_F(CommandFactoryTest, CreateWithGrayscaleTypeReturnsValidCommand) {
    ...
    // Act
    auto command = uut.create(infrastructure::config::models::ProgramType::Grayscale, config);
