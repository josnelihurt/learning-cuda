...
RUNNER_NAME="learning-cuda-cloud-vm-1"
RUNNER_LABELS="${RUNNER_LABELS:-self-hosted,Linux,X64,prod,cloud-vm}"
...
RUNNER_DOWNLOAD_URL="${RUNNER_DOWNLOAD_URL:-https://github.com/actions/runner/releases/download/${RUNNER_VERSION}/actions-runner-linux-x64-${RUNNER_VERSION_NUMBER}.tar.gz}"
