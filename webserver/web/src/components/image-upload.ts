...
export class ImageUpload extends LitElement {
    ...
    render() {
        return html`
            <div
                class="upload-container ${this.isDragging ? 'dragging' : ''} ${this.isUploading ? 'uploading' : ''}"
            ...
            >
                ...
                <div class="upload-text">
                    ${this.isUploading ? 'Uploading...' : 'Add Image'}
                </div>
                <div class="upload-hint">
                    Click or drag and drop to upload
                </div>
                <div class="upload-format">
                    Only PNG files supported (max 10MB)
                </div>
                ...
                ${this.error ? html`
                    <div class="error" data-testid="upload-error">${this.error}</div>
                ` : ''}
            </div>
