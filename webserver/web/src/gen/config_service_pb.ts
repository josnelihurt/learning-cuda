 ...
 * System information
 *
 * @generated from message cuda_learning.SystemVersion
 */
export class SystemVersion extends Message<SystemVersion> {
  ...
  /**
   * @generated from field: string build_time = 9 [json_name = "build_time"];
   */
  buildTime = "";

  /**
   * @generated from field: string commit_hash = 11 [json_name = "commit_hash"];
   */
  commitHash = "";
...
/**
 * @generated from message cuda_learning.GetSystemInfoRequest
 */
export class GetSystemInfoRequest extends Message<GetSystemInfoRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cuda_learning.GetSystemInfoRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "trace_context", jsonName: "trace_context", kind: "message", T: TraceContext },
  ]);
...
/**
 * @generated from message cuda_learning.GetSystemInfoResponse
 */
export class GetSystemInfoResponse extends Message<GetSystemInfoResponse> {
  /**
   * @generated from field: cuda_learning.SystemVersion version = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cuda_learning.GetSystemInfoResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
